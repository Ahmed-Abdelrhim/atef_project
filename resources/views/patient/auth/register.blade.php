        ...
        <div class="content">
            ...
            <form method="POST" action="{{ route('register.submit') }}" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input type="tel" required placeholder="your age" class="box @error('age') is-invalid @enderror" name="age">
                        @error('age')
                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <select class="box @error('gender') is-invalid @enderror" name="gender">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <select class="box @error('doctor_id') is-invalid @enderror" name="doctor_id">
